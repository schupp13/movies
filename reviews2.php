...
<title>MushyBanana Reviews2</title>
  ...
  <section id="hero">
    <div class="hero-container" style="background: url(img/caherobg.jpg); background-size: cover; background-repeat: no-repeat;">
      ...
      <a href="#portfolio" class="btn-get-started">Reviews</a>
    </div>
  </section><!-- #hero -->
      ...
      <div class="col-lg-12">
        ...
        <div class="row">
            ...
            <ul id="portfolio-flters">
              <li data-filter=".filter-captain_america, .filter-captain_marvel, .filter-iron_man, .filter-hulk, .filter-thor, .filter-avengers, .filter-guardians_of_the_galaxy, .filter-ant-man, .filter-doctor_strange, .filter-spider-man, .filter-black_panther" class="filter-active">All Reviews</li>
...
<!-- code from original reviews page -->
