...
<section id="hero3">
 <div class="hero-container">
   <div class="container" id="movie">
     <div class="row">
       <div class="col-lg-6">
         <img class="moviePoster" src="http://img.omdbapi.com/?i=tt0092099&h=600&apikey=579b4fff" alt="">
      </div>
     <div class="col-lg-6 align-content-left justify-content-left">
       <h1 class="movieTitle">Top Gun</h1>
     <p class="plot">As students at the United States Navy's elite fighter weapons school compete to be best in the class, one daring young pilot learns a few things from a civilian instructor that are not taught in the classroom.<p>
       ...
       <form action="../reviewProcess.php" method="POST">
               <div class="form-group">
                 ...
                 <input type="hidden" name="movie" value="tt0092099">
                 <input type="hidden" name="user" value="22">
                 <input type="hidden" name="title" value="Top Gun">
  ...
  <div class="card  bg-warning">
    ...
    <div id="collapseOne" class="collapse show" data-parent="#accordion">
      <div class="card-body text-center">
        <h3>Tom Cruise, Kelly McGillis, Val Kilmer, Anthony Edwards</h3>
      </div>
    </div>
  </div>
  ...
  <div class="card  bg-warning">
    ...
    <div id="collapseTwo" class="collapse" data-parent="#accordion">
      <div class="card-body text-center">
        ...
        <h3>Writers</h3>
        <h5>Jim Cash, Jack Epps Jr., Ehud Yonay (magazine article "Top Guns")</h5>
      </div>
    </div>
  </div>
  ...
  <div class="card  bg-warning">
    ...
    <div id="collapseThree" class="collapse" data-parent="#accordion">
      <div class="card-body text-center">
        ...
        <h5>N/A</h5>
        <h3>Awards</h3>
        <h5>Won 1 Oscar. Another 10 wins & 5 nominations.</h5>
      </div>
    </div>
  </div>
  <div class="card  bg-warning">
