...
<section id="hero3">
 <div class="hero-container">
   <div class="container" id="movie">
     <div class="row">
       <div class="col-lg-6">
         <img class="moviePoster" src="http://img.omdbapi.com/?i=tt4154796&h=600&apikey=579b4fff" alt="">
      </div>
     <div class="col-lg-6 align-content-left justify-content-left">
       <h1 class="movieTitle">Avengers: Endgame</h1>
     <p class="plot">After the devastating events of Avengers: Infinity War (2018), the universe is in ruins. With the help of remaining allies, the Avengers assemble once more in order to undo Thanos' actions and restore order to the universe.<p>
       ...
       <form action="../reviewProcess.php" method="POST">
               <div class="form-group">
                 ...
                 <input type="hidden" name="movie" value="tt4154796">
  ...
  <div class="card  bg-warning">
    ...
    <div id="collapseOne" class="collapse show" data-parent="#accordion">
      <div class="card-body text-center">
        <h3>Robert Downey Jr., Chris Evans, Mark Ruffalo, Chris Hemsworth</h3>
      </div>
    </div>
  </div>
  ...
  <div class="card  bg-warning">
    ...
    <div id="collapseTwo" class="collapse" data-parent="#accordion">
      <div class="card-body text-center">
        ...
        <h3>Writers</h3>
        <h5>Christopher Markus, Stephen McFeely, Stan Lee (based on the Marvel comics by), Jack Kirby (based on the Marvel comics by), Jim Starlin (comic book)</h5>
      </div>
    </div>
  </div>
