...
<section id="hero3">
 <div class="hero-container">
   <div class="container" id="movie">
     <div class="row">
       <div class="col-lg-6">
         <img class="moviePoster" src="http://img.omdbapi.com/?i=tt1825683&h=600&apikey=579b4fff" alt="">
      </div>
     <div class="col-lg-6 align-content-left justify-content-left">
       <h1 class="movieTitle">Black Panther</h1>
     <p class="plot">T'Challa, heir to the hidden but advanced kingdom of Wakanda, must step forward to lead his people into a new future and must confront a challenger from his country's past.<p>
       ...
       <form action="../reviewProcess.php" method="POST">
               <div class="form-group">
                 ...
                 <input type="hidden" name="movie" value="tt1825683">
                 <input type="hidden" name="user" value="22">
                 <input type="hidden" name="title" value="Black Panther">
  ...
  <div class="card  bg-warning">
    ...
    <div id="collapseOne" class="collapse show" data-parent="#accordion">
      <div class="card-body text-center">
        <h3>Chadwick Boseman, Michael B. Jordan, Lupita Nyong'o, Danai Gurira</h3>
      </div>
    </div>
  </div>
  ...
  <div class="card  bg-warning">
    ...
    <div id="collapseTwo" class="collapse" data-parent="#accordion">
      <div class="card-body text-center">
        ...
        <h3>Writers</h3>
        <h5>Ryan Coogler, Joe Robert Cole, Stan Lee (based on the Marvel comics by), Jack Kirby (based on the Marvel Comics by)</h5>
      </div>
    </div>
  </div>
