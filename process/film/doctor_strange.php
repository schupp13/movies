...
<section id="hero3">
 <div class="hero-container">
   <div class="container" id="movie">
     <div class="row">
       <div class="col-lg-6">
         <img class="moviePoster" src="http://img.omdbapi.com/?i=tt1211837&h=600&apikey=579b4fff" alt="">
      </div>
     <div class="col-lg-6 align-content-left justify-content-left">
       <h1 class="movieTitle">Doctor Strange</h1>
     <p class="plot">While on a journey of physical and spiritual healing, a brilliant neurosurgeon is drawn into the world of the mystic arts.<p>
       ...
       <form action="../reviewProcess.php" method="POST">
               <div class="form-group">
                 ...
                 <input type="hidden" name="movie" value="tt1211837">
                 <input type="hidden" name="user" value="22">
                 <input type="hidden" name="title" value="Doctor Strange">
...
<div id="accordion">
  ...
  <div class="card  bg-warning">
    ...
    <div id="collapseOne" class="collapse show" data-parent="#accordion">
      <div class="card-body text-center">
        <h3>Benedict Cumberbatch, Chiwetel Ejiofor, Rachel McAdams, Benedict Wong</h3>
      </div>
    </div>
  </div>
  ...
  <div class="card  bg-warning">
    ...
    <div id="collapseTwo" class="collapse" data-parent="#accordion">
      <div class="card-body text-center">
        <h3>Director</h3>
        <h5>Scott Derrickson</h5>
        <h3>Produced By:</h3>
        <h5>Walt Disney Pictures</h5>
        <h3>Writers</h3>
        <h5>Jon Spaihts, Scott Derrickson, C. Robert Cargill, Stan Lee (based on the Marvel comics by), Steve Ditko (based on the Marvel comics by)</h5>
      </div>
    </div>
  </div>
  ...
  <div class="card  bg-warning">
    ...
    <div id="collapseThree" class="collapse" data-parent="#accordion">
      <div class="card-body text-center">
        ...
        <h5>$232,630,718</h5>
        <h3>Awards</h3>
        <h5>Nominated for 1 Oscar. Another 20 wins & 64 nominations.</h5>
      </div>
    </div>
  </div>
  <div class="card  bg-warning">
