...
<section id="hero3">
 <div class="hero-container">
   <div class="container" id="movie">
     <div class="row">
       <div class="col-lg-6">
         <img class="moviePoster" src="http://img.omdbapi.com/?i=tt0478970&h=600&apikey=579b4fff" alt="">
      </div>
     <div class="col-lg-6 align-content-left justify-content-left">
       <h1 class="movieTitle">Ant-Man</h1>
     <p class="plot">Armed with a super-suit with the astonishing ability to shrink in scale but increase in strength, cat burglar Scott Lang must embrace his inner hero and help his mentor, Dr. Hank Pym, plan and pull off a heist that will save the world.<p>
       ...
       <form action="../reviewProcess.php" method="POST">
               <div class="form-group">
                 ...
                 <input type="hidden" name="movie" value="tt0478970">
                 <input type="hidden" name="user" value="22">
                 <input type="hidden" name="title" value="Ant-Man">
  ...
  <div class="card  bg-warning">
    ...
    <div id="collapseOne" class="collapse show" data-parent="#accordion">
      <div class="card-body text-center">
        <h3>Paul Rudd, Michael Douglas, Evangeline Lilly, Corey Stoll</h3>
      </div>
    </div>
  </div>
  ...
  <div class="card  bg-warning">
    ...
    <div id="collapseTwo" class="collapse" data-parent="#accordion">
      <div class="card-body text-center">
        ...
        <h5>Disney/Marvel</h5>
        <h3>Writers</h3>
        <h5>Edgar Wright (screenplay by), Joe Cornish (screenplay by), Adam McKay (screenplay by), Paul Rudd (screenplay by), Edgar Wright (story by), Joe Cornish (story by), Stan Lee (based on the Marvel comics by), Larry Lieber (based on the Marvel comics by), Jack Kirby (based on the Marvel comics by)</h5>
      </div>
    </div>
  </div>
  ...
  <div class="card  bg-warning">
    ...
    <div id="collapseThree" class="collapse" data-parent="#accordion">
      <div class="card-body text-center">
        ...
        <h5>$138,002,223</h5>
        <h3>Awards</h3>
        <h5>Nominated for 1 BAFTA Film Award. Another 3 wins & 32 nominations.</h5>
      </div>
    </div>
  </div>
  <div class="card  bg-warning">
